...
@Composable
fun Login(modifier: Modifier= Modifier, navController: NavController, authViewModel: AuthViewModel, newsViewModel: NewsViewModel){
...
//                    if (email!=null){
//                        newsViewModel.setCurrentUser(email)
//                    }
    ...
    Column(
        ...
        Text(text = "Welcome Back", fontSize = 42.sp, color = Color(0xFF007BFD), fontWeight = FontWeight.W700)
        ...
        TextButton(onClick = {
            ...
            Text("Don't have an Account? Signup",color = Color(0xFF007BFD))
        }
    }
}
